...
def test_domain_packages_are_importable():
    modules = [
        ...
        "app.domains.learning.content_models",
        "app.domains.learning.content_router",
        "app.domains.learning.content_schemas",
        "app.domains.learning.content_service",
        "app.domains.learning.content_tree_router",
        "app.domains.learning.models",
        "app.domains.learning.repository",
        "app.domains.learning.repositories.base",
        "app.domains.learning.repositories.content_base",
        "app.domains.learning.repositories.content_mongo",
