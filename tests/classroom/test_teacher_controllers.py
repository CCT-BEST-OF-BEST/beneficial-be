...
from app.domains.classroom.teacher_router import list_class_students, list_my_classes
from app.domains.classroom.student_view_router import get_student_records
